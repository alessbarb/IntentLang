...
export const SPEC: Spec = {
  ...
  groups: [
    ...
    },
    {
      ...
      description: "Opciones para `intent fmt` (formatter del lenguaje).",
      options: [
        {
          name: "--check",
          kind: "boolean",
          default: false,
          since: "0.3",
          description: "No escribe; falla si hay cambios pendientes.",
        },
        {
          name: "--organize-exports",
          kind: "boolean",
          default: true,
          since: "0.3",
          description: "Ordena y agrupa `exports` canónicamente.",
        },
        {
          ...
          default: true,
          since: "0.3",
          description: "Ordena `imports` y aplica coma final.",
        },
        {
          name: "--width",
          kind: "number",
          default: 80,
          since: "0.3",
          description: "Ancho objetivo (wrapping).",
        },
        {
          name: "--write",
          aliases: ["-w"],
          ...
          default: false,
          since: "0.3",
          description: "Escribe cambios al disco.",
        },
        {
          name: "--stdin",
          kind: "boolean",
          default: false,
          since: "0.3",
          description: "Lee desde stdin y escribe a stdout.",
        },
      ],
    },
  ],
